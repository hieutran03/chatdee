...
export class CreateTableConversationTableUserInConversation1757769003915 implements MigrationInterface {
    name = 'CreateTableConversationTableUserInConversation1757769003915'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "conversations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" "public"."conversations_type_enum" NOT NULL, "title" character varying(100) NOT NULL, "theme" text NOT NULL, "avatar" text NOT NULL, "created_by" uuid NOT NULL, CONSTRAINT "PK_ee34f4f7ced4ec8681f26bf04ef" PRIMARY KEY ("id"))`);
